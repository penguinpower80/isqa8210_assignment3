# Generated by Django 4.0.2 on 2022-04-09 13:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.CharField(choices=[('L', 'Low'), ('N', 'Normal'), ('C', 'Critical')], default='N', help_text='How urgent do you think this problem is?', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cost', models.FloatField(verbose_name=models.FloatField(verbose_name='Cost $'))),
